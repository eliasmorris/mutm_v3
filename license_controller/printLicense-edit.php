                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                            <h2 style="font-weight: normal;">
                                <b><?php echo'ROSA\'S MEXICAN KITCHEN & THE BAR AT BAZAAR'; ?></b> is hereby licensed 
                        ...
                        <br>
                        <br>
                        <h2 style="font-weight: normal;">The premises situated at: <b><?php echo 'JAMBIANI'; ?></b></h2>
                        <br>
                        <br>
                        <h2 style="font-weight: normal;">
                        ...
                        <h2 style="font-weight: normal; text-align: center;">
                            Date&nbsp;:&nbsp;&nbsp;<?php
                                                    ...
                                                    $time = date("d-m-Y", strtotime('11-07-2025'));
