    ...
    foreach ($arr as $key => $value) {
      ...
      if ($_SESSION['urole'] == 'Msimamizi mkuu') {
        // if ($value['status'] == 'ACTIVE') {
          ...
          echo '<a data-id="' . $value['lid'] . '" data-conf2="' . $value['lnumber'] . '" data-conf3="' . $value['licensetype'] . '" data-conf4="' . $value['bname'] . '" data-conf5="' . $value['amount'] . '" href="#editLicense" class="btn btn-xs btn-info open-editLicenseinfo" title="Bonyeza kubadili taariza za Leseni"><i class="fas fa-pencil-alt"></i></a>';
    ?>
